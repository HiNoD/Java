...
public enum Column {
	...
	private final static HashMap<Character, Column> charsToColumns = new HashMap<Character, Column>() {{
		put(A.character, A);
		put(B.character, B);
		put(C.character, C);
		put(D.character, D);
	...
	private final static HashMap<Integer, Column> ordinalsToColumns = new HashMap<Integer, Column>() {{
		put(A.ordinal(), A);
		put(B.ordinal(), B);
		put(C.ordinal(), C);
		put(D.ordinal(), D);
